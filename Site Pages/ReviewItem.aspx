     ...
     <header>
        <div class="container">
            <div class="row pageSubHeader" style="">
                <!--<h3 class="center-align" style="color:white">Add New Instrument</h3>-->
                <h3 id="pageHeader" class="center-align"></h3>
            </div>
        </div>
    </header>
...
<meta name="WebPartPageExpansion" content="full" />
                ...
                <div id="FormContent">
                    <div class="row" id="">
                        <div class="input-field col s12 m4">
                        	<div class="row">
                        		<div class="input-field col s12 m10">
									...
									*</Span></label>
		                            <input  placeholder=""   type="text" name="equipmentName" id="equipmentName" value="" required
		                                class="validate mat-input" />                          
		                        </div>
		                        <div class="input-field col s12 m2" style="   padding: 0px;font-weight:normal">
		                            <label>Id <Span class="red-text text-accent-4">
									*</Span></label>
		                            <input  placeholder="0" disabled  type="number" name="equipmentIdCustom" id="equipmentIdCustom">
		                        </div>
							</div>                            
                        </div>
                        ...
                        <div class="input-field col s12 m4">
							...
							*</Span></label>
                            <input  placeholder=""  type="text" name="manufacture" id="manufacture" value="" required class="validate  mat-input" />
        ...
        <label for="title">Title</label>-->
                    ...
                    <div class="row">
                    	<div class="input-field col s12 m4">
                        	...
                        	<input  placeholder="" type="text" required id="model" class="validate mat-input"/>
          <label for="model">Model <Span class="red-text text-accent-4">*</Span> 
                        ...
                        <div class="input-field col s12 m4">
                            ...
                            <input   placeholder=""  type="text" name="locationRoom" id="locationRoom" value="" required
                                class="validate  mat-input" />                            
                        </div>
                        <div class="input-field col s12 m4">
                            <i class="material-icons prefix">event</i>
                            <label>Manufacture Year<Span class="red-text text-accent-4">*</Span></label>
                            <input  placeholder=""   type="text" name="manufactureYear" id="manufactureYear" value="" required
                                class="validate  mat-input" />
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="input-field col s12 m4">
                            ...
                            <input placeholder=""  type="text" required id="responsibleEmployee" name="responsibleEmployee" class="autocomplete mat-input" />
                            <label for="responsibleEmployee">Main Responsible Employee<Span class="red-text text-accent-4">*</Span></label>
                        </div>
                        <div class="input-field col s12 m4">
                            <i class="material-icons prefix">person_pin</i>
                            <input placeholder="" 		 type="text" id="backupResponsible" class="autocomplete mat-input" />
                        ...
                        <div class="input-field col s12 m4">
                        	<div class="row">
                        		<div class="input-field col s12 m11">
		                            ...
		                            <select multiple class="mat-input" name="method" id="method">    
							...
							<label>Critical Instrument<Span class="red-text text-accent-4">*</Span>&nbsp;&nbsp;&nbsp;&nbsp<i style="font-size:21px;color: #837bfd;" class="material-icons tooltipped"  data-position="top" data-tooltip="Automatically calculated based on uniqueness of selected Methods">help</i></label>
							 ...
							 <datalist id="criticalIstrumentDatalist"></datalist>-->
                                    ...
                                    <div class="input-field col s12 m4">    
                                        ...
                                        <label>Setup Modification Year </label>    
                                        <input  placeholder="" type="number" name="ModificationYear " id="ModificationYear" value="" class="validate  mat-input" />    
                                    </div> 
                                    <div class="input-field col s12 m4">
										<i class="material-icons prefix">   date_range</i>    
			                              <label>Risk Assessment Date</label>    
                                        <input placeholder="" type="text" id="riskAssessmentDate" class="datepicker  datefocus  mat-input"/> 			                                        
			                        </div>  
                                    <div class="input-field col s12 m4">   
                                       <i class="material-icons prefix">   
										comment</i>   
										<label for="textarea1">Comments</label>	   
                                        <textarea  placeholder="" id="commentsI" class="materialize-textarea   mat-input"></textarea>   
            						</div>   
                                 ...
                                 <div class="row">  
                                 	...
                                 	<div class="input-field col s12 m4 contractGroupI">    
                                        ...
                                        <input  placeholder="" type="text" name="contractServiceAgreementNumber" id="contractServiceAgreementNumberI" value="" class="validate  mat-input" />    
                                    </div>    
                                ...
                                <div class="row">
                                	<div class="input-field col s12 m4 contractGroupI">    
                                        ...
                                        <input  placeholder="" type="text" name="contactPersonName" class="  mat-input" id="contactPersonNameI" />    
                                    </div> 	    
                                    <div class="input-field col s12 m4 contractGroupI">    
                                        <i class="material-icons prefix">    
			 							contact_mail</i>    
                                        <label>Contact Person Email</label>    
                                        <input  placeholder=""  type="email" name="contactPersonEmail" id="contactPersonEmailI" class="validate  mat-input" />    
                                    ...
                                    <div class="input-field col s12 m4 contractGroupI">    
                                        ...
                                        <input  placeholder=""  type="number"  name="contactPersonPhone" id="contactPersonPhoneI" value="" class="validate  mat-input" />    
                                    </div>      
                                </div> 
                                <!--<div class="row">                                	
                                ...
                                <div class="row">  
                                	<div class="input-field col s12 m4  contractGroupI" >    
                                        ...
                                        <input placeholder=""  type="text" id="renewalDateI" class="datepicker  datefocus  mat-input"/>    
                                    </div> 
                                    ...
                                    <div class="input-field col s12 m2 contractGroupI">    
                                        <i class="material-icons prefix">    
			 							repeat</i>    
                                        <label>Frequency</label>    
                                        <input placeholder=""  type="number" placeholder="0" min="0" max="60" id="frequencyI" class="validate  mat-input" />
                                    </div>
                                    <div class="input-field col s12 m1 contractGroupI" style="margin-left: -19px;">       
                                        <label>times in</label>  
                                    </div>
                                    <div class="input-field col s12 m1 contractGroupI" style="margin-left: -19px;">       
                                        <input placeholder=""  type="number" placeholder="0" min="0" max="36" id="MaintenanceFreqMonthSelector" class="validate  mat-input" />  
                                    </div>
                                    <div class="input-field col s12 m1 contractGroupI"  style="margin-left: -19px;">       
                                        <label>month/s</label>  
                                    </div>	
                    			...
                    			<div class="input-field col s12 m4 contractGroupI">    
                                        ...
                                        <input  placeholder="" type="number" step='0.01' name="Price" class="  mat-input" id="Price" />    
                                    </div> 
                                    </div>
                    ...
                    <!--<div class="row">
					      ...
					      <div id="previousattachmentsAll" class="card-panel" style="    min-height: 75px;"></div>
					        <!--<span class="white-text">I am a very simple card. I am good at containing small bits of information.
					        I am convenient because I require little markup to use effectively. I am similar to what is called a panel in other frameworks.
					        </span>-->
					...
					Modal</a>
					  ...
					  <!-- Modal Structure -->
					  <div id="modalMaintenenceSchedule" class="sidenav SidenavEqip center-align" style="width: 60% !important ; height: 100% !important ;">
					    <div class="">
		    	            ...
		    	            <div  style="display:block;padding-top: 1px;padding-bottom: 15px;background: #039be5;">
					      	...
					      	<div id="carousalid" class="carousel"  style="height: 600px;">
					  ...
					  <div id="modalcriticalEquipInstrWarning" class="modal modalcriticalEquipInstrWarning">
					    <div class="modal-content" style="    color: darkslateblue;">
					      <h5><i class="material-icons small">error</i>&nbsp; 
							Critical Equipment and Ciritcal Insturment both are set to YES! </h5>
                    ...
                    <div class="row">
                        ...
                        <a class="btn waves-effect waves-light btn-large z-depth-2" style="color:white" id="Cancel1">
						Go to Dashboard<i class="material-icons right"></i></a>
                    ...
                    <input type="text" id="upcomingLatestScheduledMaintananceDate" class="upcomingLatestScheduledMaintananceDateClass" style="display:none"/>
		...
		<!--<a class="btn waves-effect waves-light btn-large z-depth-2" id="submitSaveandContinue">
					Save & Continue<i class="material-icons right">save</i></a>-->
	...
	<button type="submit" Id="Submit" name="submit" value="Submit button"
							...
							Save & Close<i
                                    class="material-icons right">send</i></button>
                                    &nbsp;&nbsp;&nbsp;
                                    <button type="submit" Id="Submit" name="submitSaveandContinue"  value="Submit button" 
                                class="btn waves-effect waves-light btn-large z-depth-2"  style="margin-left: -470px;">
							Save & Continue<i
...
<asp:Content id="Content2" runat="server" contentplaceholderid="PlaceHolderAdditionalPageHead">
    ...
    <script type="text/javascript" src="../SiteAssets/IMS/JS/ReviewItem.js"></script>
